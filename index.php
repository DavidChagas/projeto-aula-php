                ...
                <div class="row">
                    <div class="col-md-12">
                        <div  class="painel">
                            ...
                            <form action="src/Controller/UsuarioController.php?operacao=logar" method="post" name="formLogin">
                                ...
                                <div class="cadastrar-se">Não tem conta? 
                                    <a href="src/View/Usuario/UsuarioViewCadastrar.php">Criar conta</a>
                                </div>
